<section class="section ban-chay-nhat-tuan" id="section_661749377">
    ...
    <div class="section-content relative">
        <div class="row" id="row-2041366875">
                ...
                <div class="col-inner" style="padding:0px 0px 0 0px;margin:0px 0px 0 0px;">
                    ...
                    <div class="row large-columns-3 medium-columns- small-columns-2 row-small">
                                                ...
                                                if(isset($data['products'])){
                                                    ...
                                                    if($n == 0){
                                                        echo "<center><h2>Khong co san pham</h2></center>";
                                                    }
                                                    else{
    ...
    <style scope="scope">#row-2041366875>.col>.col-inner{padding:0 0 0 0}</style>
    </div>
</div>
    <style scope="scope">#section_661749377{padding-top:0;padding-bottom:0;background-color:rgb(255,255,255)}</style>
</section>